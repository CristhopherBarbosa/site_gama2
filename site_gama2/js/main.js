...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const pesquisaCards = document.querySelectorAll('#pesquisa .bg-blue-50');
    ...
    const secoesPesquisa = [
        {
            ...
            conteudo: `
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Energia Mitocondrial</h3>
        ...
        },
        {
            ...
            conteudo: `
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Aplicações Biomédicas</h3>
        ...
        },
        {
            ...
            conteudo: `
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Nanotecnologia</h3>
    ...
    pesquisaCards.forEach((card, index) => {
        ...
        card.addEventListener('click', function() {
            ...
            secoesPesquisa.forEach(secao => {
                document.getElementById(secao.id).style.display = 'none';
            });
    ...
    const equipeMembros = [
        {
            ...
            bio: `
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Dra. Marina Silva</h3>
        ...
        },
        {
            ...
            bio: `
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Dr. Ricardo Oliveira</h3>
        ...
        },
        {
            ...
            bio: `
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Profa. Ana Costa</h3>
    ...
    const equipePesquisadores = document.querySelectorAll('#equipe .text-center');
    equipePesquisadores.forEach((card, index) => {
        card.style.cursor = 'pointer';
        card.addEventListener('click', function() {
            // Ocultar todas as biografias
            equipeMembros.forEach(membro => {
                document.getElementById(membro.id).style.display = 'none';
            });
            
            // Mostrar apenas a biografia correspondente
            const membroId = equipeMembros[index].id;
            document.getElementById(membroId).style.display = 'block';
            
            // Rolar suavemente até a biografia
            document.getElementById(membroId).scrollIntoView({behavior: 'smooth'});
        });
    });
    ...
    // Elementos para traduzir (adicione os IDs específicos do seu site)
    ...
    function translatePage(lang) {
        ...
        // Evento personalizado para notificar que a linguagem foi alterada
